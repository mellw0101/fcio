...
/* Interval time. */
#define INTERVAL_0  (1000000ULL)
#define INTERVAL_1  (300000ULL)
#define INTERVAL_2  (100000ULL)

/* Jitter forgiveness time. */
#define JITTER_0  (300000ULL)
#define JITTER_1  (150000ULL)
#define JITTER_2  (60000ULL)
